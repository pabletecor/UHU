...
addpath('../../02_FaseEntrenamiento/CasoD_knn_MD/01_CircTriangvsCuad/02_DisenoClasificador/DatosGenerados')
addpath('../../02_FaseEntrenamiento/CasoD_knn_MD/02_CirculoTriangulo/02_DisenoClasificador/DatosGenerados')
addpath('../../02_FaseEntrenamiento/CasoD_knn_MD/01_CircTriangvsCuad/02_DisenoClasificador/Funciones')
...
%     %4.3.- Clasificador Knn
%     opcion = 3;
%         load Knn_circ_cuad_triang.mat
...
%         Y_knn = YoIRed;
   ...
   %KNN
        load knn_circtriang_cuad
        espCcas_2ctc = espacioCcas;
        nombresProblema_2ctc = nombresProblemaOIRed;
        X_2ctc = XoIRed;
        Y_2ctc = YoIRed;
    ...
    for i=1:N
        ...
        if opcion==1 || opcion ==2 %MDE o MDM
            ...
            if opcion == 3
                ...
                funcion_representa_muestras_clasificacion_binaria_con_frontera...
                    (X_knn,Y_knn, nombresProblema_knn); hold on
                ...
                if op~=2 %Si es un cuadrado no seguimos evaluando
                ...
                funcion_representa_muestras_clasificacion_binaria_con_frontera...
                    (X_2ctc,Y_2ctc, nombresProblema_2ctc); hold on
                plot3(XTestoI(:,1), XTestoI(:,2), XTestoI(:,3), 'ok')
                
                subplot(1,3, 3), hold on,
                funcion_representa_muestras_clasificacion_binaria_con_frontera...
                (X_circ_triang,Y_circ_triang, nombresProblema_circ_triang, coef_circ_triang);
