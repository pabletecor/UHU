...
public class ExpertWindow extends javax.swing.JFrame {
   ...
   //private OracleConnection co=null;
...
public ExpertWindow(OracleConnection c) throws SQLException {
...
private void pideSexo() throws SQLException{
    ...
    if(SexoSelec=='M')
    {
        tmp="There is "+mExp.sexoExperto(SexoSelec)+" men at the DataBase.";
        Label.setText(tmp);
    }
    else if(SexoSelec=='F')
    {
        tmp="There is "+mExp.sexoExperto(SexoSelec)+" women at the DataBase.";
        Label.setText(tmp);
    }
    else 
    ...
    private void initComponents() {
        ...
        btmFilterbyCountry.setText("View");
