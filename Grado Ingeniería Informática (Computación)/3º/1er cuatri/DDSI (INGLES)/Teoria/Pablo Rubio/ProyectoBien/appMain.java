...
public class appMain {
    ...
    */
    public static void part2() throws SQLException {
        ...
        Scanner sc=new Scanner(System.in);
        System.out.println("*****Introduction of data from an Expert********\n");
    ...
    */
    public static void part3() throws SQLException, ParseException { 
        ...
        Expert exp=new Expert();
        PolicialcaseManager mca=new PolicialcaseManager(co);
        Policialcase ca=new Policialcase();
        String codEx;
        String codCa;
    ...
    public static void part4() throws SQLException
    {
        ...
        System.out.println("Number of men: : "+me.sexoExperto('M'));
        System.out.println("Number of women: "+me.sexoExperto('F'));
