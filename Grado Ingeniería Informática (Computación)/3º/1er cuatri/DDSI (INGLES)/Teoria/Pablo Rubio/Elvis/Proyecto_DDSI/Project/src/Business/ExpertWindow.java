...
import static Business.MainWindow.co;
 ...
 * @author usuario
 */
public class ExpertWindow extends javax.swing.JFrame {

   //private JTable tExpertos;
   private ExpertManager mExp=null;
...
public ExpertWindow(conexionOracle c) throws SQLException {
    mExp = new ExpertManager(c);
    initComponents();
    DibujarTablaExpertos();
    pideExpertos();
}

    private ExpertWindow() {
    ...
    private void DibujarTablaExpertos() {
        ...
        String[] columnasTabla = {"Code","Name","Country","Sex","Specialism"};
...
private void rellenarTablaExpertos (ArrayList<Expert> expertos) {
    Object[] columna = new Object[5];
    int numRegistros = expertos.size();
    for (int i = 0; i < numRegistros; i++) {
        columna[0] = expertos.get(i).getCodExperto();
        columna[1] = expertos.get(i).getName();
        columna[2] = expertos.get(i).getCountry();
        columna[3] = expertos.get(i).getSex();
        columna[4] = expertos.get(i).getSpecialism();
...
private void pideSexo() throws SQLException{
    ...
    if(SexoSelec=='M')
    {
        tmp="There is "+mExp.sexoExperto(SexoSelec)+" Mens at the Data Base.";
        Label.setText(tmp);
    }
    else if(SexoSelec=='F')
    {
        tmp="There is "+mExp.sexoExperto(SexoSelec)+" Womens at the Data Base.";
        Label.setText(tmp);
    }
    else 
       tmp=""+ mExp.sexoExperto(SexoSelec);
    ...
    private void initComponents() {
        ...
        btmFilterbyCountry = new javax.swing.JToggleButton();
        btmListAll = new javax.swing.JToggleButton();
        jLabel1 = new javax.swing.JLabel();
        txtSexo = new javax.swing.JTextField();
        btmCount = new javax.swing.JButton();
        ...
        EquiquetaPais.setText("Country");

        btmFilterbyCountry.setText("Filer by Country");
        btmFilterbyCountry.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmFilterbyCountryActionPerformed(evt);
            }
        });

        btmListAll.setText("List All");
        btmListAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmListAllActionPerformed(evt);
            }
        });
        ...
        btmCount.setText("Count");
        btmCount.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmCountActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(EquiquetaPais)
                    .addComponent(btmFilterbyCountry, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btmListAll))
                .addGap(20, 20, 20)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
    ...
    private void btmFilterbyCountryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmFilterbyCountryActionPerformed
        vaciarTablaExpertos();
        try {
            pideExpertosPorPais();
    ...
    }//GEN-LAST:event_btmFilterbyCountryActionPerformed

    private void btmListAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmListAllActionPerformed
        vaciarTablaExpertos();
        try {
            pideExpertos();
        } catch (SQLException ex) {
    ...
    }//GEN-LAST:event_btmListAllActionPerformed

    private void txtSexoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSexoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtSexoActionPerformed

    private void btmCountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmCountActionPerformed
       try {
           // TODO add your handling code here:
           pideSexo();
       } catch (SQLException ex) {
    ...
    }//GEN-LAST:event_btmCountActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpertWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ExpertWindow().setVisible(true);
    ...
    private javax.swing.JButton btmCount;
    private javax.swing.JToggleButton btmFilterbyCountry;
    private javax.swing.JToggleButton btmListAll;
