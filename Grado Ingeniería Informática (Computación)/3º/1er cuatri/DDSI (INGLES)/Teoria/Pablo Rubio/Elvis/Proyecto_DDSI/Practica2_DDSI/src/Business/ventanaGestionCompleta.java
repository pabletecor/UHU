...
public class ventanaGestionCompleta extends javax.swing.JFrame {
    ...
    private ExpertManager mExp;
    private CaseManager mCa=null;
    private CollaboratesManager mCo=null;
    Expert exp=null;
    conexionOracle co;
    ...
    public ventanaGestionCompleta(conexionOracle co) {
        this.co=co;
        mExp=new ExpertManager(co);
        mCo = new CollaboratesManager(co);
        mCa = new CaseManager(co);
        initComponents();
    ...
    private Expert RecogerDatos()
    {
        ...
        if(Codigo!=null && Nombre!=null && Pais!=null && Sexo!=null && Especialidad!=null)
        {
           // InsertaExperto.setEnabled(true);
            ex=new Expert(Codigo,Nombre,Pais,Sexo,Especialidad);
        }
        return ex;
    }
...
private void rellenarTablaCasos (ArrayList<Case> caso) {
    Object[] columna = new Object[5];
...
private void rellenarTablaColaboraciones (ArrayList<Collaborates> colaboraciones) {
    Object[] columna = new Object[5];
    ...
    */
    ...
    ArrayList<Case> lCa = mCa.listaCasos();
    rellenarTablaCasos (lCa);
}
    
    private void pideColaboraciones() throws SQLException {
    ArrayList<Collaborates> lCo = mCo.listaColaboraciones();
    ...
    private void InsertaColaboracionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertaColaboracionActionPerformed
        try {
            ...
            {*/
                ...
                Collaborates co=new Collaborates(CodExp, CodCaso, Fecha, txtDescripcion.getText());
