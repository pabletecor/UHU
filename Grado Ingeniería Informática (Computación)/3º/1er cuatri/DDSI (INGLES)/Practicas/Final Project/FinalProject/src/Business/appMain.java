...
//        }
    ...
    public static void exercise1() throws SQLException {
        ...
        String s = code.nextLine();
        if(expertManager.expertExists(s) ){
            System.out.println("Experto con codigo " + s + " existe");
        }
...
//    }
    ...
    public static void exercise2() throws SQLException {
        ...
        boolean created = expertManager.insertExpert(exp);
     ...
     */
    public static void exercise3() throws SQLException, ParseException {
